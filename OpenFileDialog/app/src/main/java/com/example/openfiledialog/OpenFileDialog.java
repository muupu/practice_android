...
public class OpenFileDialog {
    ...
    public static Dialog createDialog(int id, Context context, String title, OnCloseListener callback, String suffix, Map<String, Integer> images){
    ...
    static class FileSelectView extends ListView implements OnItemClickListener{
        ...
        public FileSelectView(Context context, int dialogid, OnCloseListener callback, String suffix, Map<String, Integer> images) {
            super(context);
